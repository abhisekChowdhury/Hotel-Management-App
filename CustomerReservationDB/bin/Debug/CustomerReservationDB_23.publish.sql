...
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (1, N'Occupaid', 1, N'Economic', 431)
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (2, N'Occupaid', 2, N'Deluxe', 242)
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (3, N'Occupaid', 4, N'Economic', 271)
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (4, N'Occupaid', 4, N'Economic', 251)
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (5, N'Occupaid', 4, N'Economic', 219)
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (6, N'Occupaid', 2, N'Economic', 278)
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (7, N'Occupaid', 4, N'Economic', 416)
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (8, N'Occupaid', 1, N'Economic', 293)
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (9, N'Occupaid', 1, N'Economic', 206)
insert into [dbo].[Rooms] (RoomId, RoomStatus, NumberOfBeds, RoomType, RoomPrice) values (10, N'Occupaid', 1, N'Economic', 356)
SET IDENTITY_INSERT [dbo].[Employees] OFF
GO


insert into [dbo].[Reservations] (ReservationId, CheckInDate, CheckOutDate, FoodService, RoomId, EmployeeId, CustomerId) values (1, '10/31/2020', '11/10/2020', N'N', 3, 1, 4);
insert into [dbo].[Reservations] (ReservationId, CheckInDate, CheckOutDate, FoodService, RoomId, EmployeeId, CustomerId) values (2, '10/5/2020', '10/15/2020', N'N', 6, 1, 2);
insert into [dbo].[Reservations] (ReservationId, CheckInDate, CheckOutDate, FoodService, RoomId, EmployeeId, CustomerId) values (3, '8/21/2020', '8/31/2020', N'N', 9, 3, 1);
insert into [dbo].[Reservations] (ReservationId, CheckInDate, CheckOutDate, FoodService, RoomId, EmployeeId, CustomerId) values (4, '5/29/2020', '6/8/2020', N'Y', 10, 2, 6);
insert into [dbo].[Reservations] (ReservationId, CheckInDate, CheckOutDate, FoodService, RoomId, EmployeeId, CustomerId) values (5, '3/18/2020', '3/28/2020', N'N', 2, 3, 7);
GO
