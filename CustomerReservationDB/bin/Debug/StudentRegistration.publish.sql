...
ALTER TABLE [dbo].[Courses]
    ADD CONSTRAINT [FK_Courses_ToDepartment] FOREIGN KEY ([CourseDepartmentId]) REFERENCES [dbo].[Departments] ([DepartmentId]) ON DELETE CASCADE;
...
GO
PRINT N'Creating [dbo].[FK_Students_ToDepartments]...';


GO
ALTER TABLE [dbo].[Students]
    ADD CONSTRAINT [FK_Students_ToDepartments] FOREIGN KEY ([StudentMajor]) REFERENCES [dbo].[Departments] ([DepartmentId]);
