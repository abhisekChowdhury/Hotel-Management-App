...
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (1, N'Vaclav', N'Chirm', N'1044516087', N'647 Algoma Trail', N'11/25/1989')
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (2, N'Weber', N'Carrol', N'2793403172', N'778 Barby Park', N'4/8/1987')
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (3, N'Reube', N'Eilert', N'4561157945', N'73 Bunting Drive', N'7/14/1990')
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (4, N'Etty', N'Kirley', N'3802551109', N'5251 Manitowish Circle', N'11/30/1996')
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (5, N'Delila', N'Huckel', N'6563842375', N'8630 Vidon Parkway', N'5/20/1988')
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (6, N'Cass', N'Aronovich', N'7236792336', N'925 School Park', N'3/4/1995')
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (7, N'Erek', N'De Simone', N'9652807448', N'3373 Steensland Drive', N'9/30/1994')
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (8, N'Loren', N'Hilhouse', N'4153877218', N'9 Chive Point', N'2/28/1999')
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (9, N'Wyndham', N'Brydon', N'1408814027', N'16686 Dayton Point', N'7/1/1991')
insert into [dbo].[Customers] ([CustomerId], [FirstName], [LastName], [PhoneNumber], [BillingAddress], [DOB]) values (10, N'Yulma', N'Wayland', N'5302859334', N'36 Pepper Wood Plaza', N'12/29/1980')
