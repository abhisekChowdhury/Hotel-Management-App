...
insert into [dbo].[Rooms] (RoomId, RoomStatus, RoomTypeId) values (1, N'Occupied', 1)
...
insert into [dbo].[Rooms] (RoomId, RoomStatus, RoomTypeId) values (4, N'Occupied', 3)
insert into [dbo].[Rooms] (RoomId, RoomStatus, RoomTypeId) values (5, N'Occupied', 3)
insert into [dbo].[Rooms] (RoomId, RoomStatus, RoomTypeId) values (6, N'Occupied', 2)
insert into [dbo].[Rooms] (RoomId, RoomStatus, RoomTypeId) values (7, N'Occupied', 2)
insert into [dbo].[Rooms] (RoomId, RoomStatus, RoomTypeId) values (8, N'Occupied', 1)
